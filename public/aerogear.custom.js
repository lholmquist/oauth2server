/*! AeroGear JavaScript Library - v1.3.0-dev - 2013-09-23
...
AeroGear.Pipeline.adapters.Rest.prototype.read = function( options ) {
    ...
    if( !this.getAuthorizer() ) {
        ...
        return this.getAuthorizer().read( jQuery.extend( {}, options, extraOptions ) );
    }
};
...
AeroGear.Authorization.adapters.OAuth2 = function( name, settings ) {
    ...
    var type = "OAuth2",
        ...
        state = uuid(), //TODO: make this autogenerated. Recommended in the spec,
...
AeroGear.Authorization.adapters.OAuth2.prototype.read = function( options ) {
